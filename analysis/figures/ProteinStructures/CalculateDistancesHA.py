...
parser = PDBParser()
structure = parser.get_structure('HA', 'reference/H3-4hmg.pdb')
...
# Iterate through all of the residues in chain A (head domain)
# and chain B (stalk domain).
...
with open('analysis/figures/ProteinStructures/4HMG-SialicAcidDistances.data','w') as f:
